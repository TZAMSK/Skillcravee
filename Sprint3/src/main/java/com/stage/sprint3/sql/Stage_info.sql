...
INSERT INTO `stagedb2`.`professeur`(nom, prenom, email, password) VALUES
                                                                                ('emile', 'lerouge', 'emile@gmail.com','pass123'),
                                                                                ('Doe', 'John', 'johndoe1@example.com','password123'),
                                                                                ('Smith', 'Jane', 'janesmith2@example.com', 'password456'),
                                                                                ('Johnson', 'Michael', 'michaeljohnson3@example.com', 'password789'),
                                                                                ('Lee', 'Anna', 'annalee4@example.com','password111'),
                                                                                ('Kim', 'David', 'davidkim5@example.com', 'password222'),
                                                                                ('Garcia', 'Maria', 'mariagarcia6@example.com', 'password333'),
                                                                                ('Brown', 'William', 'williambrown7@example.com', 'password444'),
                                                                                ('Martinez', 'Jose', 'josemartinez8@example.com', 'password555'),
                                                                                ('Miller', 'Jessica', 'jessicamiller9@example.com', 'password666'),
